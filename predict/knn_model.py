...
#
#
# def run_simulation(fm_bd_input, bank=100, bet_strategy='knn', bank_stragey=0.75):
#     u_event=fm_bd_input[['Event_Date', 'T_Event_URL']].drop_duplicates().sort_values('Event_Date', ascending=True)
#
